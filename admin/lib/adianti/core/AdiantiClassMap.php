...
class AdiantiClassMap
{
    ...
    public static function getMap()
    {
        ...
        $classPath['Response']                        = 'lib/mad/rest/Response.php';
        $classPath['Request']                         = 'lib/mad/rest/Request.php';
        $classPath['Router']                          = 'lib/mad/rest/Router.php';
        $classPath['Route']                           = 'lib/mad/rest/Route.php';
        $classPath['JSONResponse']                    = 'lib/mad/rest/JSONResponse.php';
