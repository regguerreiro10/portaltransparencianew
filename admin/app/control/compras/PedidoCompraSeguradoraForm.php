...
class PedidoCompraSeguradoraForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        $obs = new TText('obs');
        $veiculos_id = new TDBCombo('veiculos_id', 'minierp', 'Veiculos', 'id', '{placa} {marca}','id asc' , $criteria_veiculos_id );
        ...
        $row3 = $tab_666d91088c834->addFields([new TLabel("Obs:", null, '14px', null, '100%'),$obs],[new TLabel("Veiculos:", null, '14px', null),$veiculos_id]);
        ...
        $row10 = $this->form->addFields([new TLabel("Tipo do pedido:", '#FF0000', '14px', null, '100%'),$tab_666d91088c834,new TLabel("Rótulo:", null, '14px', null)]);
        ...
        $btn_onsetproject = $this->form->addAction("Voltar", new TAction(['PedidoCompraSeguradoraList', 'onSetProject']), 'fas:arrow-left #000000');
        ...
        $style = new TStyle('right-panel > .container-part[page-name=PedidoCompraSeguradoraForm]');
...
private function registrarHistoricoPedido($pedido)
  ...
  /*  private function atualizaDetalhesPedido($pedido){
     ...
     private function atualizaDetalhesPedido($pedido){
         TToast::show('success', "Registro salvo", 'topRight', 'far:check-circle');
            TApplication::loadPage('PedidoCompraSeguradoraList', 'onShow');
         /*
