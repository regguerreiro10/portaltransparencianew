...
class CompraReport extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    private static $formName = 'form_CompraReport';
    ...
    public function __construct( $param = null)
    {
        ...
        $this->form->setFormTitle("Relatório de Compras");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Compras","Relatório de Compras"]));
        }
