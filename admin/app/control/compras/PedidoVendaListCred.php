...
class PedidoVendaListCred extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $id = new TDBCombo('id', 'minierp', 'Cartao', 'id', '{numero_cartao}','id asc' , $criteria_id );
        ...
        $row5 = $this->form->addFields([new TLabel("Cartão:", null, '14px', null, '100%'),$id],[]);
        ...
        $column_ = new TDataGridColumn('', "Vl Cotação", 'right' , '120px');
        ...
        $action2 = new TDataGridAction(['PedidoVendaFormCred', 'onEdit'],   ['id' => '{id}']);
        $action3 = new TDataGridAction([$this, 'onDelete'],   ['id' => '{id}']);
        $action4 = new TDataGridAction(['PedidoVendaDocument', 'onGenerate'],   ['id' => '{id}']);
        $action5 = new TDataGridAction([$this, 'onEnviarCotacao'],   ['id' => '{id}']);
        $action6 = new TDataGridAction(['CotacaoPendenteCredList', 'onSetProject'],   ['id' => '{id}']);
        $action7 = new TDataGridAction(['CotacaoPendenteCredList', 'onSetProject'],   ['id' => '{id}']);
        ...
        $action2->setDisplayCondition('PedidoVendaListCred::onExibirEditar');

        $action3->setLabel('Excluir');
        $action3->setImage('fas:trash-alt #dd5a43');
        $action3->setDisplayCondition('PedidoVendaListCred::onExibirExcluir');
        ...
        $action13->setDisplayCondition('PedidoVendaListCred::onExibirDocCotacao');

        $action5->setLabel('Gerar Cotação');
        $action5->setImage('fas:envelope #E91E63');
        $action5->setDisplayCondition('PedidoVendaListCred::onExibirEnvio');

        $action6->setLabel('Aprovar');
        $action6->setImage('fas:thumbs-up #9C27B0');
        $action6->setDisplayCondition('PedidoVendaListCred::onExibirAprovar');

        $action7->setLabel('Reprovar');
        $action7->setImage('fas:thumbs-down #F44336');
        $action7->setDisplayCondition('PedidoVendaListCred::onExibirReprovar');

        $action8->setLabel('Cancelar pedido');
        $action8->setImage('fas:times-circle #E91E63');
        $action8->setDisplayCondition('PedidoVendaListCred::onExibirCancelado');

        $action9->setLabel('Gerar financeiro');
        $action9->setImage('fas:money-bill-wave #FFA500');
        $action9->setDisplayCondition('PedidoVendaListCred::onExibirGerarFinanceiro');

        $action10->setLabel('Finalizar pedido');
        $action10->setImage('fas:door-closed #009688');
        $action10->setDisplayCondition('PedidoVendaListCred::onExibirFinalizar');

        $action11->setLabel('Anexos');
        $action11->setImage('fas:paperclip #795548');
        $action11->setDisplayCondition('PedidoVendaListCred::onExibirAnexos');

        $action12->setLabel('Cancelar Aprovação');
        $action12->setImage('fas:undo #009688');
        $action12->setDisplayCondition('PedidoVendaListCred::onExibirCancelarAprovacao');
...
/*
        ...
        $action_onEdit = new TDataGridAction(array('PedidoVendaFormCred', 'onEdit'));
        $action_onEdit->setUseButton(false);
        $action_onEdit->setButtonClass('btn btn-default btn-sm');
        $action_onEdit->setLabel("Editar");
        $action_onEdit->setImage('far:edit #478fca');
        $action_onEdit->setField(self::$primaryKey);
        $action_onEdit->setDisplayCondition('PedidoVendaListCred::onExibirEditar');

        $this->datagrid->addAction($action_onEdit);

        $action_onDelete = new TDataGridAction(array('PedidoVendaListCred', 'onDelete'));
        $action_onDelete->setUseButton(false);
        $action_onDelete->setButtonClass('btn btn-default btn-sm');
        $action_onDelete->setLabel("Excluir");
        $action_onDelete->setImage('fas:trash-alt #dd5a43');
        $action_onDelete->setField(self::$primaryKey);
        $action_onDelete->setDisplayCondition('PedidoVendaListCred::onExibirExcluir');
        ...
        $action_CotacaoVendaDocumentPedido_onGenerate->setDisplayCondition('PedidoVendaListCred::onExibirDocCotacao');

        $this->datagrid->addAction($action_CotacaoVendaDocumentPedido_onGenerate);

        $action_onEnviarCotacao = new TDataGridAction(array('PedidoVendaListCred', 'onEnviarCotacao'));
        ...
        $action_onEnviarCotacao->setDisplayCondition('PedidoVendaListCred::onExibirEnvio');

        $this->datagrid->addAction($action_onEnviarCotacao);

        $action_onSetProject = new TDataGridAction(array('CotacaoPendenteCredList', 'onSetProject'));
        ...
        $action_onSetProject->setDisplayCondition('PedidoVendaListCred::onExibirAprovar');

        $this->datagrid->addAction($action_onSetProject);

        $action_CotacaoPendenteCredList_onSetProject = new TDataGridAction(array('CotacaoPendenteCredList', 'onSetProject'));
        $action_CotacaoPendenteCredList_onSetProject->setUseButton(false);
        $action_CotacaoPendenteCredList_onSetProject->setButtonClass('btn btn-default btn-sm');
        $action_CotacaoPendenteCredList_onSetProject->setLabel("Reprovar");
        $action_CotacaoPendenteCredList_onSetProject->setImage('fas:thumbs-down #F44336');
        $action_CotacaoPendenteCredList_onSetProject->setField(self::$primaryKey);
        $action_CotacaoPendenteCredList_onSetProject->setDisplayCondition('PedidoVendaListCred::onExibirReprovar');

        $this->datagrid->addAction($action_CotacaoPendenteCredList_onSetProject);

        $action_onCancelarPedido = new TDataGridAction(array('PedidoVendaListCred', 'onCancelarPedido'));
        ...
        $action_onCancelarPedido->setDisplayCondition('PedidoVendaListCred::onExibirCancelado');

        $this->datagrid->addAction($action_onCancelarPedido);

        $action_onGerarFinanceiro = new TDataGridAction(array('PedidoVendaListCred', 'onGerarFinanceiro'));
        ...
        $action_onGerarFinanceiro->setDisplayCondition('PedidoVendaListCred::onExibirGerarFinanceiro');

        $this->datagrid->addAction($action_onGerarFinanceiro);

        $action_onFinalizarPedido = new TDataGridAction(array('PedidoVendaListCred', 'onFinalizarPedido'));
        ...
        $action_onFinalizarPedido->setDisplayCondition('PedidoVendaListCred::onExibirFinalizar');
        ...
        $action_DocumentosCotacaoPedidoList_onSetProject->setDisplayCondition('PedidoVendaListCred::onExibirAnexos');

        $this->datagrid->addAction($action_DocumentosCotacaoPedidoList_onSetProject);

        $action_onCancelarAprovacao = new TDataGridAction(array('PedidoVendaListCred', 'onCancelarAprovacao'));
        ...
        $action_onCancelarAprovacao->setDisplayCondition('PedidoVendaListCred::onExibirCancelarAprovacao');
...
*/
        ...
        $button_cadastrar->setAction(new TAction(['PedidoVendaFormCred', 'onShow']), "Cadastrar");
        ...
        $btnShowCurtainFilters->setAction(new TAction(['PedidoVendaListCred', 'onShowCurtainFilters']), "Filtros");
        ...
        $button_limpar_filtros->setAction(new TAction(['PedidoVendaListCred', 'onClearFilters']), "Limpar filtros");
        ...
        $button_atualizar->setAction(new TAction(['PedidoVendaListCred', 'onRefresh']), "Atualizar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['PedidoVendaListCred', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['PedidoVendaListCred', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['PedidoVendaListCred', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['PedidoVendaListCred', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Compras","Pedidos de venda cartao credito"]));
        }
    ...
    public function onEnviarCotacao($param = null) 
    {
            ...
            try {
                ...
                $repository = new TRepository('ViewEnviarcotacao'); 
                ...
                //$criteria->setProperty('group', 'pessoa_id');
...
/*        try 
                ...
                if ($objects)
                {
                    ...
                    foreach ($objects as $object)
                    {
                        ...
                        foreach ($this->datagrid->getColumns() as $column)
                        {
                            ...
                            if(($column_name == 'cidade_id') || ($column_name == 'descricaopedido') || ($column_name == 'cliente->nome')){
    ...
    public static function onShowCurtainFilters($param = null) 
    {
        try 
        {
            ...
            $page->setProperty('page-name', 'PedidoVendaListCredSearch');
            $page->setProperty('page_name', 'PedidoVendaListCredSearch');
    ...
    public function onSearch($param = null)
    {
        ...
        if (isset($data->id) AND ( (is_scalar($data->id) AND $data->id !== '') OR (is_array($data->id) AND (!empty($data->id)) )) )
        {
            ...
            $filters[] = new TFilter('cartao_id', '=', $data->id);// create the filter 
        }
