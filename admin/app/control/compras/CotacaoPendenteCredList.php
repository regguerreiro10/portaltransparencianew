...
class CotacaoPendenteCredList extends TPage
{
...
private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $action_onAprovar = new TDataGridAction(array('CotacaoPendenteCredList', 'onAprovar'));
        ...
        $action_onAprovar->setDisplayCondition('CotacaoPendenteCredList::onExibirAprovada');

        $this->datagrid->addAction($action_onAprovar);

        $action_onReprovar = new TDataGridAction(array('CotacaoPendenteCredList', 'onReprovar'));
        ...
        $action_onReprovar->setDisplayCondition('CotacaoPendenteCredList::onExibirReprovada');
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['CotacaoPendenteCredList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['CotacaoPendenteCredList', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['CotacaoPendenteCredList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['CotacaoPendenteCredList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Compras","CotacaoPendenteCredList"]));
        }
