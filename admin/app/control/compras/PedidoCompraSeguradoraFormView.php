...
class PedidoCompraSeguradoraFormView extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $transformed_pedido_veiculos_id = call_user_func(function($value, $object, $row)
        {
            //code here
        ...
        }, $pedido->veiculos_id, $pedido, null);
        ...
        $seguradora = new TLabel("Seguradora:", '', '14px', 'B', '100%');
        ...
        $label4 = new TLabel("Placa:", '', '14px', 'B', '100%');
        $textplaca = new TTextDisplay($transformed_pedido_veiculos_id, '', '16px', '');
...
/*
        ...
        $row2 = $this->form->addFields([$label,$text1],[$seguradora,$text7],[$label6,$text12],[$label8,$text5]);
        ...
        $row4 = $this->form->addFields([$label14,$text6],[$label4,$textplaca]);
...
*/
 //</onBeforeAddFieldsToForm>
        ...
        $btnPedidoVendaDocumentOnGenerateAction = new TAction(['PedidoVendaDocument', 'onGenerate'],['key'=>$pedido->id]);
        ...
        $style = new TStyle('right-panel > .container-part[page-name=PedidoCompraSeguradoraFormView]');
