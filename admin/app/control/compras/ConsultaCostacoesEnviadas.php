...
class ConsultaCostacoesEnviadas extends TWindow
{
    ...
    private static $formName = 'formList_Cotacao';
    private $limit = 20;
    ...
    public function __construct($param = null)
    {
        ...
        $column_estado_pedido_nome = new TDataGridColumn('estado_pedido->nome', "Estado pedido id", 'left');
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['ConsultaCostacoesEnviadas', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['ConsultaCostacoesEnviadas', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['ConsultaCostacoesEnviadas', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['ConsultaCostacoesEnviadas', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
