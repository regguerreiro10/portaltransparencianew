...
class PedidoVendaDocumentForn extends TPage
{
    private static $database = 'minierp';
    private static $activeRecord = 'Pedido';
    private static $primaryKey = 'id';
    private static $htmlFile = 'app/documents/PedidoVendaDocumentFornTemplate.html';
    ...
    public static function onGenerate($param)
    {
        try 
        {
          ...
          //  var_dump($objectsItensPedido_pedido_venda_id);
    //        die();
