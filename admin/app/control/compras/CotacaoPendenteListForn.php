...
class CotacaoPendenteListForn extends TPage
{
    private $form; // form
    ...
    private static $formName = 'form_CotacaoPendenteFornList';
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Consulta Cotação Pendente Fornecedor");
        $this->limit = 20;
        ...
        $action_onAprovar = new TDataGridAction(array('CotacaoPendenteListForn', 'onAprovar'));
        ...
        $action_onAprovar->setDisplayCondition('CotacaoPendenteListForn::onExibirAprovada');

        $this->datagrid->addAction($action_onAprovar);

        $action_onReprovar = new TDataGridAction(array('CotacaoPendenteListForn', 'onReprovar'));
        ...
        $action_onReprovar->setDisplayCondition('CotacaoPendenteListForn::onExibirReprovada');
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['CotacaoPendenteListForn', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['CotacaoPendenteListForn', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['CotacaoPendenteListForn', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['CotacaoPendenteListForn', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Compras","CotacaoPendenteListForn"]));
        }
