...
class SystemRequestLogList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $basename   = urlencode('log-request-list.pdf');
        $download   = "download.php?file=app/manual/log-request-list.pdf&basename={$basename}";
        ...
        $this->form->setFormTitle("Request Log {$manual}");
