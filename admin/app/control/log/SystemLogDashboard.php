...
{
    private $form; // form
    private static $formName = 'SystemLogDashboardForm';
    /**
     * Class constructor
     * Creates the page
     */
    function __construct()
    {
        ...
        if (empty($log_errors))
        {
            ...
            return;
                    ...
                    $basename   = urlencode('log-dashboard-list.pdf');
        $download   = "download.php?file=app/manual/log-dashboard-list.pdf&basename={$basename}";
        ...
        $this->form->setFormTitle("Dashboard Log {$manual}");
