...
class ContaReceberForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $row3 = $this->form->addFields([new TLabel("Forma de pagamento:", '#ff0000', '14px', null, '100%'),$forma_pagamento_id],[new TLabel("Departamentos / Unidades", '#FF0000', '14px', null, '100%'),$departamento_unit_id]);
