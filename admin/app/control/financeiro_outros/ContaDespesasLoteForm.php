...
class ContaDespesasLoteForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    private static $formName = 'form_ContaDespesasLoteForm';
    ...
    public function __construct( $param = null)
    {
        ...
        $style = new TStyle('right-panel > .container-part[page-name=ContaDespesasLoteForm]');
        ...
        try
        {
            ...
            if($fieldListContasData)
            {
                ...
                foreach($fieldListContasData as $contaData)
                {
                    ...
                    $conta->tipo_conta_id = TipoConta::DESPESA;
                ...
                new TMessage('info', 'Contas criadas!', new TAction(['ContaDespesasList', 'onShow']));
