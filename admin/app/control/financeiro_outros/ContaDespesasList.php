...
class ContaDespesasList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'form_ContaDespesasList';
    ...
    public function __construct($param = null)
    {
        ...
        $action_onShow = new TDataGridAction(array('ContaDespesasFormView', 'onShow'));
        ...
        $action_onEdit = new TDataGridAction(array('ContaDespesasForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('ContaDespesasList', 'onDelete'));
        ...
        $action_onQuitar = new TDataGridAction(array('ContaDespesasForm', 'onQuitar'));
        ...
        $action_onQuitar->setDisplayCondition('ContaDespesasList::onExibirQuitar');
        ...
        $btnShowCurtainFilters->setAction(new TAction(['ContaDespesasList', 'onShowCurtainFilters']), "Filtros");
        ...
        $button_cadastrar->setAction(new TAction(['ContaDespesasForm', 'onShow']), "Cadastrar");
        ...
        $button_cadastrar_lote->setAction(new TAction(['ContaDespesasLoteForm', 'onShow']), "Cadastrar Lote");
        ...
        $button_atualizar->setAction(new TAction(['ContaDespesasList', 'onRefresh']), "Atualizar");
        ...
        $button_limpar_filtros->setAction(new TAction(['ContaDespesasList', 'onClearFilters']), "Limpar filtros");
        ...
        $button_atrasadas->setAction(new TAction(['ContaDespesasList', 'onFiltrarAtrasadas']), "Atrasadas");
        ...
        $button_abertas->setAction(new TAction(['ContaDespesasList', 'onFiltrarAbertas']), "Abertas");
        ...
        $button_quitadas->setAction(new TAction(['ContaDespesasList', 'onFiltrarQuitadas']), "Quitadas");
        ...
        $button_quitar_em_lote->setAction(new TAction(['QuitarContaDespesasLoteForm', 'onShow']), "Quitar em Lote");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['ContaDespesasList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['ContaDespesasList', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['ContaDespesasList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['ContaDespesasList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
    ...
    public static function onShowCurtainFilters($param = null) 
    {
        try 
        {
            ...
            $page->setProperty('page-name', 'ContaDespesasListSearch');
            $page->setProperty('page_name', 'ContaDespesasListSearch');
