...
class QuitarContaReceitasLoteForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    private static $formName = 'form_QuitarContaReceitasLoteForm';
    ...
    public function __construct( $param = null)
    {
        ...
        $style = new TStyle('right-panel > .container-part[page-name=QuitarContaReceitasLoteForm]');
