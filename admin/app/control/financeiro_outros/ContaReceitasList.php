...
class ContaReceitasList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'form_ContaReceitasList';
    ...
    public function __construct($param = null)
    {
        ...
        $action_onShow = new TDataGridAction(array('ContaReceitasFormView', 'onShow'));
        ...
        $action_onEdit = new TDataGridAction(array('ContaReceitasForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('ContaReceitasList', 'onDelete'));
        ...
        $action_onQuitar = new TDataGridAction(array('ContaReceitasForm', 'onQuitar'));
        ...
        $action_onQuitar->setDisplayCondition('ContaReceitasList::onExibirQuitarConta');
        ...
        $button_cadastrar->setAction(new TAction(['ContaReceitasForm', 'onShow']), "Cadastrar");
        ...
        $button_atualizar->setAction(new TAction(['ContaReceitasList', 'onRefresh']), "Atualizar");
        ...
        $btnShowCurtainFilters->setAction(new TAction(['ContaReceitasList', 'onShowCurtainFilters']), "Filtros");
        ...
        $button_limpar_filtros->setAction(new TAction(['ContaReceitasList', 'onClearFilters']), "Limpar filtros");
        ...
        $button_atrasadas->setAction(new TAction(['ContaReceitasList', 'onFiltrarAtrasadas']), "Atrasadas");
        ...
        $button_abertas->setAction(new TAction(['ContaReceitasList', 'onFiltrarAbertas']), "Abertas");
        ...
        $button_quitadas->setAction(new TAction(['ContaReceitasList', 'onFiltrarQuitadas']), "Quitadas");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['ContaReceitasList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['ContaReceitasList', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['ContaReceitasList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['ContaReceitasList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
    ...
    public static function onShowCurtainFilters($param = null) 
    {
        try 
        {
            ...
            $page->setProperty('page-name', 'ContaReceitasListSearch');
            $page->setProperty('page_name', 'ContaReceitasListSearch');
