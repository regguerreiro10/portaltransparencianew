...
class NegociacaoAtividadeGlobalCalendarForm extends TWindow
{
    ...
    public function __construct( $param )
    {
        ...
        $criteria_negociacao_id = new TCriteria();
        $criteria_tipo_atividade_id = new TCriteria();

        $id = new TEntry('id');
        $negociacao_id = new TDBCombo('negociacao_id', 'minierp', 'Negociacao', 'id', '#{id} - {cliente->nome} - {etapa_negociacao->nome}','id asc' , $criteria_negociacao_id );
