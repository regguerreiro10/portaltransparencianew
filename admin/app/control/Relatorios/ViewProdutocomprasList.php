...
class ViewProdutocomprasList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'ViewProdutocompras';
    private static $primaryKey = 'id';
    private static $formName = 'form_ViewProdutocomprasList';
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Listagem de Pedidos por Estabelecimento, Estado Pedido e Analítico");
        $this->limit = 20;
        ...
        $row1 = $this->form->addFields([new TLabel("ID Pedido:", null, '14px', null, '100%'),$pedido_id],[new TLabel("ID Estabelecimento:", null, '14px', null, '100%'),$pessoa_id]);
        ...
        $row3 = $this->form->addFields([new TLabel("Estado pedido:", null, '14px', null, '100%'),$estado_pedido_venda_id],[new TLabel("Dt pedido:", null, '14px', null, '100%'),$dt_pedido]);
        ...
        $column_nomeestabelecimento = new TDataGridColumn('nomeestabelecimento', "Nomeestabelecimento", 'left');
        ...
        $column_nomeproduto = new TDataGridColumn('nomeproduto', "Nomeproduto", 'left');
        $column_qtde = new TDataGridColumn('qtde', "Qtde", 'left');
        $column_valor_unitario_transformed = new TDataGridColumn('valor_unitario', "Valor unitario", 'left');
        ...
        $column_estado_pedido_venda_id_transformed->setTransformer(function($value, $object, $row, $cell = null, $last_row = null)
        {
                            ...
                            return "<span class='label label-default' style='width:260px; background-color:{$estadopedido->cor} display:inline-block;'> {$estadopedido->nome} </span>";
        ...
        $this->datagrid->addColumn($column_valor_unitario_transformed);
        ...
        $panel = new TPanelGroup("Listagem de Pedidos por Estabelecimento, Estado Pedido e Analítico");
        ...
        $btnShowCurtainFilters->setAction(new TAction(['ViewProdutocomprasList', 'onShowCurtainFilters']), "Filtros");
        ...
        $button_limpar_filtros->setAction(new TAction(['ViewProdutocomprasList', 'onClearFilters']), "Limpar filtros");
        ...
        $button_atualizar->setAction(new TAction(['ViewProdutocomprasList', 'onRefresh']), "Atualizar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['ViewProdutocomprasList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['ViewProdutocomprasList', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['ViewProdutocomprasList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['ViewProdutocomprasList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
    ...
    public static function onShowCurtainFilters($param = null) 
    {
        try 
        {
            ...
            $page->setProperty('page-name', 'ViewProdutocomprasListSearch');
            $page->setProperty('page_name', 'ViewProdutocomprasListSearch');
            ...
            $style = new TStyle('right-panel > .container-part[page-name=ViewProdutocomprasListSearch]');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for ViewProdutocompras
            ...
            if ($objects)
            {
                ...
                foreach ($objects as $object)
                {
                    ...
                    $row->id = "row_{$object->pedido_id}";
                    $total_valor_unitario = $total_valor_unitario + $object->valor_unitario;
            ...
            $total_object->pessoa_id = 'TOTAL GERAL'; // necessário para evitar erro
            $total_object->valor_unitario = number_format($total_valor_unitario ?? 0, 2, ',', '.');
    ...
    public static function manageRow($id, $param = [])
    {
        ...
        $object = new ViewProdutocompras($id);
