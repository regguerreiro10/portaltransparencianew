...
private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $panel = new TPanelGroup("Listagem de tipo Fornecedores / Clientes");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Fornecedores / Clientes","Tipo Fornecedores / Clientes"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                $relations = [
                    'Pessoa'     => ['column' => 'tipo_cliente_id', 'alias' => 'Pessoa']
                ];
