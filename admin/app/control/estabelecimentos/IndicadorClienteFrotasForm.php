...
class IndicadorClienteFrotasForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param = null)
    {
        ...
        $criteria_quantidade_de_pedidos->add(new TFilter('propostas.estado_pedido_frotas_id', 'not in', $filterVar)); 
        ...
        $criteria_quantidade_de_pedidos->add(new TFilter('propostas.pessoa_id', '=', $filterVar)); 
        $filterVar = TSession::getValue('idunit');
        $criteria_quantidade_de_pedidos->add(new TFilter('propostas.system_unit_id', '=', $filterVar));

        $filterVar = [EstadoPedidoFrotas::REPROVADO, EstadoPedidoFrotas::CANCELADO];
        $criteria_total_vendas_pedido->add(new TFilter('propostas.estado_pedido_frotas_id', 'not in', $filterVar)); 
        ...
        $filterVar = TSession::getValue(__CLASS__.'load_filter_estabelecimento_id');
        $criteria_total_vendas_pedido->add(new TFilter('propostas.pessoa_id', '=', $filterVar)); 
        $filterVar = TSession::getValue('idunit');
        $criteria_total_vendas_pedido->add(new TFilter('propostas.system_unit_id', '=', $filterVar));
        ...
        $quantidade_de_pedidos->setFieldValue("propostas.id");
        $quantidade_de_pedidos->setModel('Propostas');
        ...
        $criteria_quantidade_de_pedidos->add(new TFilter('propostas.deleted_at', 'is', NULL));
        ...
        $total_vendas_pedido->setFieldValue("propostas.valor_liquido");
        $total_vendas_pedido->setModel('Propostas');
        ...
        $criteria_total_vendas_pedido->add(new TFilter('propostas.deleted_at', 'is', NULL));
