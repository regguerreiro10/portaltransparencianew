...
class PessoaFormFrotasView extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        //  $action3 = new TActionLink("Quitar Antecipação", new TAction(['AntecipacaoForm', 'onShow'], ['key'=> $pessoa->id]), '', '12px', '', 'fas:calendar-check #4CAF50');
        // $bpagecontainer2 = new BPageContainer();
   //     $action_gerar_extrato = new TActionLink("Gerar Extrato", new TAction(['PessoaContaReceberEmAbertoDocument', 'onGenerate'], ['key'=> $pessoa->id]), '', '12px', '', 'fas:file-invoice-dollar #4CAF50');
      ...
      //  $bpagecontainer_contas_em_aberto->setSize('100%');
        ...
        $indicadores_cliente->setAction(new TAction(['IndicadorClienteFrotasForm', 'onShow'], ['estabelecimento_id' => $pessoa->id]));
        $listagem_de_pedidos->setAction(new TAction(['ClientePedidoFrotasList', 'onShow'], ['estabelecimento_id' => $pessoa->id]));
    ...
    //    $action3->class = 'btn btn-default';
      ...
      //  $bpagecontainer_contas_em_aberto->add($loadingContainer);
        ...
        $tab_622940daf9f3b->appendPage("Propostas");
