...
class ItensPedidoFrotasServicoList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'form_ItensPedidoFrotasServicoList';
    ...
    public function __construct($param = null)
    {
        ...
        $column_produto_id = new TDataGridColumn('produto_id', "ID Serviço", 'left', '70px');
        $column_produto_nome = new TDataGridColumn('produto->nome', "Nome do Serviço", 'left', '400px');
        ...
        $action_onEdit = new TDataGridAction(array('ItensPedidoFrotasServicoForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('ItensPedidoFrotasServicoList', 'onDelete'));
        ...
        // $Cadastrar->setAction(new TAction(['ItensPedidoFrotasServicoForm', 'onShow']), "Cadastrar");
