...
class EntradaVeiculo extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        $criteria_condutor_entrada_id = new TCriteria();

        $condutor_entrada_id = new TDBCombo('condutor_entrada_id', 'minierp', 'Condutor', 'id', '{nome}','nome asc' , $criteria_condutor_entrada_id );
        // $condutor_retirada_id = new TDBCombo('condutor_retirada_id', 'minierp', 'Pessoa', 'id', '{nome}','nome asc' , $criteria_condutor_retirada_id );
        $dataentrada = new TDate('dataentrada');
        // $dataretirada = new TDate('dataretirada');

        $row1 = $this->form->addFields([new TLabel("Condutor de entrada do veículo:", null, '14px', null, '100%'),$condutor_entrada_id],[new TLabel("Data de entrada:", null, '14px', null, '100%'),$dataentrada]);
    ...
    public function onSave($param) 
    {
        try
        {
            ...
            $object->dataentrada = $data->dataentrada;
