...
class ItensPedidoFrotasServicoForm extends TPage
{
    ...
    private static $formName = 'form_ItensPedidoFrotasServicoForm';
    ...
    public function __construct( $param )
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Serviço:", '#FF0000', '14px', null, '100%'),$id, $produto_id],[new TLabel("Nome:", null, '14px', null, '100%'),$produto_id1]);
        ...
        $style = new TStyle('right-panel > .container-part[page-name=ItensPedidoFrotasServicoForm]');
    ...
    public static function onChangefamilia_produto_id($param)
    {
        try
        {
            ...
            TSession::setValue('tipo', 2); // servico
