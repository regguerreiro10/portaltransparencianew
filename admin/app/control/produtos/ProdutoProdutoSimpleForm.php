...
class ProdutoProdutoSimpleForm extends TPage
{
    ...
    private static $formName = 'form_ProdutoProdutoSimpleForm';
    ...
    public function __construct( $param )
    {
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Pedido","ProdutoProdutoSimpleForm"]));
        }
