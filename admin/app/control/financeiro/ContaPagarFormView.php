...
class ContaPagarFormView extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $label10 = new TLabel("Data de aprovação:", '', '14px', 'B', '100%');
        ...
        $label20 = new TLabel("Valor Liquido:", '', '14px', 'B', '100%');
        $text9 = new TTextDisplay(number_format((double)$conta->valor_liquido, '2', ',', '.'), '', '16px', '');
