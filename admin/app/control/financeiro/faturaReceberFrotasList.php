...
class faturaReceberFrotasList extends TPage
{
...
private $form; // form
    ...
    private static $formName = 'form_faturaReceberFrotasList';
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Listagem das faturas a receber Frotas");
        $this->limit = 20;
        ...
        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null, '100%'),$id],[new TLabel("Data de finalização:", null, '14px', null, '100%'), $dt_finalizacao]);
      ...
      //  $this->datagrid->addColumn($column_forma_pagamento_nome);
        ...
        $action_onComprovante = new TDataGridAction(['ContaComprovantePagamentoViewList', 'onShow']);
        $action_onComprovante->setUseButton(false);
        $action_onComprovante->setButtonClass('btn btn-default btn-sm');
        $action_onComprovante->setLabel('Comprovante');
        $action_onComprovante->setImage('fas:paperclip #2196F3');
        $action_onComprovante->setField(self::$primaryKey);
        $action_onComprovante->setParameter('conta_id', '{id}');
        $action_onComprovante->setDisplayCondition('faturaReceberFrotasList::onExibirComprovante');
        ...
        // use SEMPRE o campo chave da linha
        ...
        $panel = new TPanelGroup("Listagem das faturas a receber Frotas");
        ...
        $btnShowCurtainFilters->setAction(new TAction(['faturaReceberFrotasList', 'onShowCurtainFilters']), "Filtros");
        ...
        $button_atualizar->setAction(new TAction(['faturaReceberFrotasList', 'onRefresh']), "Atualizar");
        ...
        $button_limpar_filtros->setAction(new TAction(['faturaReceberFrotasList', 'onClearFilters']), "Limpar filtros");
        ...
        $button_atrasadas->setAction(new TAction(['faturaReceberFrotasList', 'onFiltrarAtrasadas']), "Atrasadas");
        ...
        $button_abertas->setAction(new TAction(['faturaReceberFrotasList', 'onFiltrarAbertas']), "Abertas");
        ...
        $button_quitadas->setAction(new TAction(['faturaReceberFrotasList', 'onFiltrarQuitadas']), "Quitadas");
     ...
     /*   $button_quitar_em_lote = new TButton('button_button_quitar_em_lote');
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['faturaReceberFrotasList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['faturaReceberFrotasList', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['faturaReceberFrotasList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['faturaReceberFrotasList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
    ...
    public static function onExibirComprovante($object)
    {
        try
        {
            ...
            $anexo = ContaAnexo::where('conta_id', '=', $object->id)
