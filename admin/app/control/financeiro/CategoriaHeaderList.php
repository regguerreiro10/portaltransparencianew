...
private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $basename   = urlencode('categoria-header-list.pdf');
        $download   = "download.php?file=app/manual/categoria-header-list.pdf&basename={$basename}";
        ...
        $panel = new TPanelGroup("Listagem de categorias {$manual}");
