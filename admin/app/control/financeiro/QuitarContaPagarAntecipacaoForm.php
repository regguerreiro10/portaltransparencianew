...
class QuitarContaPagarAntecipacaoForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param = null)
    {
        ...
        $this->form->setFormTitle("Quitar contas a pagar por antecipação");
        ...
        $contas->setValue(TSession::getValue('ContaPagarEmAbertoSimpleListbuilder_datagrid_check'));
        $obs->setSize('100%', 70);
        ...
        $column_contas_valor_transformed = $contas->addColumn('valor_liquido', "Valor", 'center' , '20%');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            if($data->contas)
            {
                ...
                new TMessage('info', 'Contas quitadas com sucesso!', new TAction(['ContaPagarEmAbertoSimpleList', 'onShow']));
