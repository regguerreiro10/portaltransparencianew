...
private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null, '100%'),$id],[new TLabel("Data de vencimento:", null, '14px', null, '100%'),$dt_vencimento]);
        ...
        $column_departamento_unit_id = new TDataGridColumn('departamento_unit->name', "Departamento", 'center');
      ...
      //  $this->datagrid->addColumn($column_forma_pagamento_nome);
        ...
        // $action_onFatura = new TDataGridAction(['FaturaForm', 'onEdit']);
        // $action_onFatura->setUseButton(false);
        // $action_onFatura->setButtonClass('btn btn-default btn-sm');
        // $action_onFatura->setLabel("Consultar Fatura");
        // $action_onFatura->setImage('fas:search #4CAF50');

        // // use SEMPRE o campo chave da linha
        // $action_onFatura->setField(self::$primaryKey);

        // // passe o fatura_id como parâmetro que o form espera (id)
        ...
        // $button_cadastrar = new TButton('button_button_extrato');
        // $button_cadastrar->setAction(new TAction(['ContaPagarForm', 'onShow']), "Gerar Extrato");
    ...
    public function onSearch($param = null)
    {
        ...
        // $filters[] = new TFilter('pessoa_id', '=', $filterVar);// create the filter 
        // $filterVar = TipoConta::PAGAR;
        // $filters[] = new TFilter('tipo_conta_id', '=', $filterVar);// create the filter 
        // $filterVar = NULL;
        // $filters[] = new TFilter('dt_pagamento', '=', $filterVar);// create the filter 
