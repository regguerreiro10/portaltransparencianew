...
class FamiliaForm extends TPage
{
    ...
    private static $formName = 'form_FamiliaForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de familia");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['FamiliaList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new Familia(); // create an empty object 
            ...
            {
                TApplication::loadPage('FamiliaList', 'onShow', $loadPageParam);
            }
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new Familia($key); // instantiates the Active Record 
