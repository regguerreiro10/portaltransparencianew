...
class EspecieForm extends TPage
{
    ...
    private static $formName = 'form_EspecieForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de espécie");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['EspecieList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            {
                TApplication::loadPage('EspecieList', 'onShow', $loadPageParam);
            }
