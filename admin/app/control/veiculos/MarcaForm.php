...
class MarcaForm extends TPage
{
    ...
    private static $formName = 'form_MarcaForm';
    ...
    public function __construct( $param )
    {
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['MarcaList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            TApplication::loadPage('MarcaList', 'onShow', $loadPageParam); 
