...
class TipoVeiculoForm extends TPage
{
    ...
    private static $formName = 'form_TipoVeiculoForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro tipo");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['TipoVeiculoList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new TipoVeiculo(); // create an empty object 
            ...
            TApplication::loadPage('TipoVeiculoList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new TipoVeiculo($key); // instantiates the Active Record 
