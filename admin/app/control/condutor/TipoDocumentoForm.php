...
class TipoDocumentoForm extends TPage
{
    ...
    private static $formName = 'form_TipoDocumentoForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de tipo documento");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['TipoDocumentoList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            {
                TApplication::loadPage('TipoDocumentoList', 'onShow', $loadPageParam);
            }
