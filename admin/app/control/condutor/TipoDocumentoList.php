...
private $form; // form
    ...
    private static $formName = 'form_TipoDocumentoList';
 ...
 $basename   = urlencode('tipo-documento-list.pdf');
$download   = "download.php?file=app/manual/tipo-documento-list.pdf&basename={$basename}";
...
"; 
        ...
        $this->form->setFormTitle("Listagem de tipo documentos {$manual}");
        $this->limit = 20;
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['TipoDocumentoList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['TipoDocumentoList', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['TipoDocumentoList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['TipoDocumentoList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
           // $container->add(TBreadCrumb::create(["Estabelecimentos","Tipo documentos"]));
        }
