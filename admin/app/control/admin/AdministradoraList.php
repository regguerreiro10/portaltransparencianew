...
class AdministradoraList extends TPage
{
...
private $form; // form
    ...
    private static $formName = 'form_AdministradoraList';
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Listagem de administradoras");
        $this->limit = 20;
        ...
        $row2 = $this->form->addFields([new TLabel("Cnpj:", null, '14px', null, '100%'),$cnpj],[new TLabel("Email:", null, '14px', null, '100%'),$email]);
        $row2->layout = ['col-sm-6','col-sm-6'];      

        $row5 = $this->form->addFields([new TLabel("Telefone01:", null, '14px', null, '100%'),$telefone01],[new TLabel("Cidade id:", null, '14px', null, '100%'),$cidade_id]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['AdministradoraForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $column_cidade_id_transformed = new TDataGridColumn('cidade_id', "Cidade id", 'left');
        ...
        $action_onEdit = new TDataGridAction(array('AdministradoraForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('AdministradoraList', 'onDelete'));
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['AdministradoraList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['AdministradoraList', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['AdministradoraList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['AdministradoraList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Compras","Administradoras"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new Administradora($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Administradora
