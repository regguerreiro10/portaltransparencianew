...
//        $unit   = '<span class="login-avatar"><span class="fa fa-university"></span></span>';
        ...
        if (!empty($param['previous_class']) && $param['previous_class'] == 'LoginFormAdmin') {
    ...
    public function onLogin($param)
    {
        ...
        try
        {
            ...
            $user = GenesisAuthenticationService::authenticate( $data->email,  $data->password, $emailcliente );
            ...
            if ($user)
            {
                ...
                TSession::setValue('entidade',null); 
                 ...
                 TSession::setValue('tipofrota',null); 
                 TSession::setValue('sistema',null); 
                 TSession::setValue('abastecimento',null); 
                ...
                if ($unit) {
                    ...
                    if ($entidade->tipo_frota=="1") {
                       TSession::setValue('tipofrota',1);
                    } elseif ($entidade->tipo_frota=="2") {
                       TSession::setValue('tipofrota',2);
                    } else {
                       TSession::setValue('tipofrota',3);
                    }
                    TSession::setValue('aprovacao_por_item',null);
                    TSession::setValue('selecao_redes_aleatoria',null);
                    TSession::setValue('pedido_base',null);
                    TSession::setValue('testar_revisao',null);
                    TSession::setValue('bloqueio_valor_temparia',null);
                    TSession::setValue('exige_dotacao_empenho_frotas',null);
                    TSession::setValue('enviar_email_auto_relatorio',null);
                    TSession::setValue('garantia_dias',null);
                    TSession::setValue('garantia_km',null);
                    TSession::setValue('produto_percentual_similar',null);
                    TSession::setValue('checklist_vistoria_veiculo',null);
                    TSession::setValue('utiliza_temparia',null);
                    TSession::setValue('exibir_popup_plano_manutencao',null);
                    ...
                    TSession::setValue('bloqueio_valor_temparia',$unit->bloqueio_valor_temparia);
                    TSession::setValue('pedido_base',$unit->pedido_base);
                    TSession::setValue('testar_revisao',$unit->testar_revisao);
                    TSession::setValue('enviar_email_auto_relatorio',$unit->enviar_email_auto_relatorio);
                    TSession::setValue('garantia_dias',$unit->garantia_dias);
                    TSession::setValue('garantia_km',$unit->garantia_km);
                    TSession::setValue('produto_percentual_similar',$unit->produto_percentual_similar);
                    TSession::setValue('utiliza_temparia',$unit->utiliza_temparia);
                    TSession::setValue('abastecimento',$entidade->abastecimento);
                    TSession::setValue('exibir_popup_plano_manutencao',$unit->exibir_popup_plano_manutencao);                    
                    TSession::setValue('checklist_vistoria_veiculo',$unit->checklist_vistoria_veiculo);                    
                    TSession::setValue('exige_dotacao_empenho_frotas',$unit->exige_dotacao_empenho_frotas);                    
                }
