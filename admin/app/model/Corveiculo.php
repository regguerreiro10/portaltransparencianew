...
class Corveiculo extends TRecord
{
    const TABLENAME  = 'corveiculo';
    const PRIMARYKEY = 'id';
    ...
    public function getVeiculoss()
    {
        ...
        $criteria->add(new TFilter('corveiculo_id', '=', $this->id));
    ...
    public function get_veiculos_dispositivos_to_string()
    {
        ...
        $values = Veiculos::where('corveiculo_id', '=', $this->id)->getIndexedArray('dispositivos_id','{dispositivos->id}');
    ...
    public function get_veiculos_marca_to_string()
    {
        ...
        $values = Veiculos::where('corveiculo_id', '=', $this->id)->getIndexedArray('marca_id','{marca->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_modelo_to_string()
    {
        ...
        $values = Veiculos::where('corveiculo_id', '=', $this->id)->getIndexedArray('modelo_id','{modelo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_tipo_combustivel_to_string()
    {
        ...
        $values = Veiculos::where('corveiculo_id', '=', $this->id)->getIndexedArray('tipo_combustivel_id','{tipo_combustivel->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_corveiculo_to_string()
    {
        ...
        $values = Veiculos::where('corveiculo_id', '=', $this->id)->getIndexedArray('corveiculo_id','{corveiculo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_propriedade_to_string()
    {
        ...
        $values = Veiculos::where('corveiculo_id', '=', $this->id)->getIndexedArray('propriedade_id','{propriedade->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_tipo_veiculo_to_string()
    {
        ...
        $values = Veiculos::where('corveiculo_id', '=', $this->id)->getIndexedArray('tipo_veiculo_id','{tipo_veiculo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_system_unit_to_string()
    {
        ...
        $values = Veiculos::where('corveiculo_id', '=', $this->id)->getIndexedArray('system_unit_id','{system_unit->name}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_subsystem_unit_to_string()
    {
        ...
        $values = Veiculos::where('corveiculo_id', '=', $this->id)->getIndexedArray('departamento_unit_id','{subsystem_unit->name}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_system_users_to_string()
    {
        ...
        $values = Veiculos::where('corveiculo_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
    ...
    public function onBeforeDelete()
    {
        ...
        if(Veiculos::where('corveiculo_id', '=', $this->id)->first())
        {
