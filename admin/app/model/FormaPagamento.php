...
class FormaPagamento extends TRecord
{
    ...
    public function get_conta_departamento_unit_to_string()
    {
        ...
        $values = Conta::where('forma_pagamento_id', '=', $this->id)->getIndexedArray('departamento_unit_id','{departamento_unit->name}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_system_users_to_string()
    {
        ...
        $values = Conta::where('forma_pagamento_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
