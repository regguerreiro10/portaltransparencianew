...
class Marca extends TRecord
{
    ...
    public function getModelos()
    {
        ...
        $criteria->add(new TFilter('marca_id', '=', $this->id));
        return Modelo::getObjects( $criteria );
    }
    /**
     * Method getVeiculoss
     */
    ...
    public function set_modelo_marca_to_string($modelo_marca_to_string)
    {
        if(is_array($modelo_marca_to_string))
        {
            $values = Marca::where('id', 'in', $modelo_marca_to_string)->getIndexedArray('id', 'id');
            $this->modelo_marca_to_string = implode(', ', $values);
        }
        else
        {
            $this->modelo_marca_to_string = $modelo_marca_to_string;
        }

        $this->vdata['modelo_marca_to_string'] = $this->modelo_marca_to_string;
    }

    public function get_modelo_marca_to_string()
    {
        if(!empty($this->modelo_marca_to_string))
        {
            return $this->modelo_marca_to_string;
        }
    
        $values = Modelo::where('marca_id', '=', $this->id)->getIndexedArray('marca_id','{marca->id}');
    ...
    public function get_veiculos_dispositivos_to_string()
    {
        ...
        $values = Veiculos::where('marca_id', '=', $this->id)->getIndexedArray('dispositivos_id','{dispositivos->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_marca_to_string()
    {
        ...
        $values = Veiculos::where('marca_id', '=', $this->id)->getIndexedArray('marca_id','{marca->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_modelo_to_string()
    {
        ...
        $values = Veiculos::where('marca_id', '=', $this->id)->getIndexedArray('modelo_id','{modelo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_tipo_combustivel_to_string()
    {
        ...
        $values = Veiculos::where('marca_id', '=', $this->id)->getIndexedArray('tipo_combustivel_id','{tipo_combustivel->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_corveiculo_to_string()
    {
        ...
        $values = Veiculos::where('marca_id', '=', $this->id)->getIndexedArray('corveiculo_id','{corveiculo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_propriedade_to_string()
    {
        ...
        $values = Veiculos::where('marca_id', '=', $this->id)->getIndexedArray('propriedade_id','{propriedade->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_tipo_veiculo_to_string()
    {
        ...
        $values = Veiculos::where('marca_id', '=', $this->id)->getIndexedArray('tipo_veiculo_id','{tipo_veiculo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_system_unit_to_string()
    {
        ...
        $values = Veiculos::where('marca_id', '=', $this->id)->getIndexedArray('system_unit_id','{system_unit->name}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_subsystem_unit_to_string()
    {
        ...
        $values = Veiculos::where('marca_id', '=', $this->id)->getIndexedArray('departamento_unit_id','{subsystem_unit->name}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_system_users_to_string()
    {
        ...
        $values = Veiculos::where('marca_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
    ...
    public function onBeforeDelete()
    {
        ...
        if(Modelo::where('marca_id', '=', $this->id)->first())
        {
            throw new Exception("Não é possível deletar este registro pois ele está sendo utilizado em outra parte do sistema");
        }
    
        if(Veiculos::where('marca_id', '=', $this->id)->first())
        {
            throw new Exception("Não é possível deletar este registro pois ele está sendo utilizado em outra parte do sistema");
        }
