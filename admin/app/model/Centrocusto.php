...
class Centrocusto extends TRecord
{
    ...
    public function getPedidos()
    {
        ...
        $criteria->add(new TFilter('centrocusto_id', '=', $this->id));
    ...
    public function get_pedido_tipo_pedido_to_string()
    {
        ...
        $values = Pedido::where('centrocusto_id', '=', $this->id)->getIndexedArray('tipo_pedido_id','{tipo_pedido->nome}');
    ...
    public function get_pedido_cliente_to_string()
    {
        ...
        $values = Pedido::where('centrocusto_id', '=', $this->id)->getIndexedArray('cliente_id','{cliente->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_vendedor_to_string()
    {
        ...
        $values = Pedido::where('centrocusto_id', '=', $this->id)->getIndexedArray('vendedor_id','{vendedor->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_estado_pedido_venda_to_string()
    {
        ...
        $values = Pedido::where('centrocusto_id', '=', $this->id)->getIndexedArray('estado_pedido_venda_id','{estado_pedido_venda->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_condicao_pagamento_to_string()
    {
        ...
        $values = Pedido::where('centrocusto_id', '=', $this->id)->getIndexedArray('condicao_pagamento_id','{condicao_pagamento->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_transportadora_to_string()
    {
        ...
        $values = Pedido::where('centrocusto_id', '=', $this->id)->getIndexedArray('transportadora_id','{transportadora->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_negociacao_to_string()
    {
        ...
        $values = Pedido::where('centrocusto_id', '=', $this->id)->getIndexedArray('negociacao_id','{negociacao->id}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_situacao_pedido_to_string()
    {
        ...
        $values = Pedido::where('centrocusto_id', '=', $this->id)->getIndexedArray('situacao_pedido_id','{situacao_pedido->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_departamento_unit_to_string()
    {
        ...
        $values = Pedido::where('centrocusto_id', '=', $this->id)->getIndexedArray('departamento_unit_id','{departamento_unit->name}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_centrocusto_to_string()
    {
        ...
        $values = Pedido::where('centrocusto_id', '=', $this->id)->getIndexedArray('centrocusto_id','{centrocusto->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_system_users_to_string()
    {
        ...
        $values = Pedido::where('centrocusto_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_cartao_to_string()
    {
        ...
        $values = Pedido::where('centrocusto_id', '=', $this->id)->getIndexedArray('cartao_id','{cartao->id}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_veiculos_to_string()
    {
        ...
        $values = Pedido::where('centrocusto_id', '=', $this->id)->getIndexedArray('veiculos_id','{veiculos->id}');
        return implode(', ', $values);
    }
    ...
    public function onBeforeDelete()
    {
        ...
        if(Pedido::where('centrocusto_id', '=', $this->id)->first())
        {
