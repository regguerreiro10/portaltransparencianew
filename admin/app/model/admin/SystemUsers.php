...
class SystemUsers extends TRecord
{
    ...
    public function __construct($id = NULL, $callObjectLoad = TRUE)
    {
        ...
        parent::addAttribute('notificarusuario');
    }
     ...
     * @param $object Instance of SystemProgram
     */
    public function addSystemUserDepartamentoUnit(DepartamentoUnit $systemuserdepartamentounit)
    {
        $object = new SystemUserDepartamentoUnit;
        $object->departamento_unit_id = $systemuserdepartamentounit->id;
        $object->system_users_id = $this->id;
        $object->store();
    }
