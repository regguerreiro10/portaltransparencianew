...
class Modelo extends TRecord
{
    const TABLENAME  = 'modelo';
    const PRIMARYKEY = 'id';
    ...
    public function getVeiculoss()
    {
        ...
        $criteria->add(new TFilter('modelo_id', '=', $this->id));
        return Veiculos::getObjects( $criteria );
    }
    /**
     * Method getModeloAnos
     */
    public function getModeloAnos()
    {
        $criteria = new TCriteria;
        $criteria->add(new TFilter('modelo_id', '=', $this->id));
        return ModeloAno::getObjects( $criteria );
    }
    ...
    public function get_veiculos_dispositivos_to_string()
    {
        ...
        $values = Veiculos::where('modelo_id', '=', $this->id)->getIndexedArray('dispositivos_id','{dispositivos->id}');
    ...
    public function get_veiculos_marca_to_string()
    {
        ...
        $values = Veiculos::where('modelo_id', '=', $this->id)->getIndexedArray('marca_id','{marca->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_modelo_to_string()
    {
        ...
        $values = Veiculos::where('modelo_id', '=', $this->id)->getIndexedArray('modelo_id','{modelo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_tipo_veiculo_to_string()
    {
        ...
        $values = Veiculos::where('modelo_id', '=', $this->id)->getIndexedArray('tipo_veiculo_id','{tipo_veiculo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_system_unit_to_string()
    {
        ...
        $values = Veiculos::where('modelo_id', '=', $this->id)->getIndexedArray('system_unit_id','{system_unit->name}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_departamento_unit_to_string()
    {
        ...
        $values = Veiculos::where('modelo_id', '=', $this->id)->getIndexedArray('departamento_unit_id','{departamento_unit->name}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_system_users_to_string()
    {
        ...
        $values = Veiculos::where('modelo_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_tipo_combustivel_to_string()
    {
        ...
        $values = Veiculos::where('modelo_id', '=', $this->id)->getIndexedArray('tipo_combustivel_id','{tipo_combustivel->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_propriedade_to_string()
    {
        ...
        $values = Veiculos::where('modelo_id', '=', $this->id)->getIndexedArray('propriedade_id','{propriedade->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_status_veiculo_to_string()
    {
        ...
        $values = Veiculos::where('modelo_id', '=', $this->id)->getIndexedArray('status_veiculo_id','{status_veiculo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_corveiculo_to_string()
    {
        ...
        $values = Veiculos::where('modelo_id', '=', $this->id)->getIndexedArray('corveiculo_id','{corveiculo->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_especie_to_string()
    {
        ...
        $values = Veiculos::where('modelo_id', '=', $this->id)->getIndexedArray('especie_id','{especie->id}');
        return implode(', ', $values);
    }
    ...
    public function get_veiculos_familia_to_string()
    {
        ...
        $values = Veiculos::where('modelo_id', '=', $this->id)->getIndexedArray('familia_id','{familia->id}');
        return implode(', ', $values);
    }

    
    public function set_modelo_ano_modelo_to_string($modelo_ano_modelo_to_string)
    {
        if(is_array($modelo_ano_modelo_to_string))
        {
            $values = Modelo::where('id', 'in', $modelo_ano_modelo_to_string)->getIndexedArray('id', 'id');
            $this->modelo_ano_modelo_to_string = implode(', ', $values);
        }
        else
        {
            $this->modelo_ano_modelo_to_string = $modelo_ano_modelo_to_string;
        }

        $this->vdata['modelo_ano_modelo_to_string'] = $this->modelo_ano_modelo_to_string;
    }

    public function get_modelo_ano_modelo_to_string()
    {
        if(!empty($this->modelo_ano_modelo_to_string))
        {
            return $this->modelo_ano_modelo_to_string;
        }
        
        $values = ModeloAno::where('modelo_id', '=', $this->id)->getIndexedArray('modelo_id','{modelo->id}');
        return implode(', ', $values);
    }
